...
const GameDetail: React.FC = () => {
  ...
  React.useEffect(() => {
    ...
    (async () => {
      try {
        ...
        // โหลด Minimum Spec จากตารางจริง (ใช้ minimum_spec_id ก่อน, แล้ว fallback เป็น game_id)
        try {
  ...
  // ราคา/ส่วนลด (รองรับทั้ง base_price/discounted_price หรือ price/discount_percent)
  ...
  // Minimum Spec (มาจากตาราง minimumspec)
  const ms = minSpec ?? {};
          ...
          <div>
            ...
            <Space size="middle" wrap>
              <Tooltip title="Add to Wishlist">
                <Button icon={<HeartOutlined />} onClick={() => msg.success("Added to wishlist")} ghost>
                  Wishlist
                </Button>
              </Tooltip>
              <Button type="primary" icon={<ShoppingCartOutlined />} onClick={() => msg.success("Added to cart")}>
                Add to Cart
              </Button>
            </Space>
          </div>
